...
//		SaladChef scKo = new SaladChef("고길동");
		...
		SaladChef[] salads = {new SaladChef("이승철") , new SaladChef("홍길동")};
		...
		// 세번째 단계		
		System.out.println("=============================");
		System.out.println("다형성 파트");

		 Chef[] chefs = {new MainPartChef("홍길동") , new MainPartChef("둘리"), new SaladPartChef("이승철") , new SaladPartChef("홍길동")};
